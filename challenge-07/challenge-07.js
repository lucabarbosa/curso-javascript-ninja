...
*/
var array = ['Palmeiras', 1951, function() { return 'O Palmeiras tem mundial.'; }, { Palmeiras: { mundial: true, libertadores: true }  }, null];
...
*/
console.log(addItem([ { Rivais: ['Corinthians', 'Santos', 'São Paulo'] }, 3, true ]));
